...
export function ForgotPasswordScreen({ onBack, onNavigate }: ForgotPasswordScreenProps) {
  ...
  if (isSubmitted) {
    return (
      <div className="h-screen bg-[#F9FAFB] flex items-center justify-center p-6">
        <motion.div
  ...
  return (
    <div className="h-screen bg-[#F9FAFB] overflow-y-auto">
      {/* Header */}
      <div className="bg-gradient-to-br from-[#043b69] to-[#032d51] text-white p-6 pb-16">
        <div className="max-w-md mx-auto">
          <motion.button
            whileTap={{ scale: 0.9 }}
            onClick={onBack}
            className="p-2 hover:bg-white/10 mb-4"
          >
