...
export function TransactionDetails({ transaction, onBack, onNavigate }: TransactionDetailsProps) {
  const steps = [
    { label: "Initiated", completed: true, date: "Oct 24, 2025 10:30 AM" },
    { label: "In Escrow", completed: true, date: "Oct 24, 2025 10:35 AM" },
  ...
  const activityLog = [
    ...
    { action: "Seller notified", date: "Oct 24, 2025 10:36 AM", user: "System" },
    { action: "Seller confirmed shipment", date: "Oct 25, 2025 09:15 AM", user: "Alice Smith" },
  ];
